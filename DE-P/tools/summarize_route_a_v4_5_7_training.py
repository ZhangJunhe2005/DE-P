#!/usr/bin/env python3
"""Compact V4.5.7 high-safety joint-shakedown summary."""
...
RUN_ROOT = ROOT / "runs/route_a_static_yopo_v4_5_7_high_safety_retimed"
...
def selected_metrics(value):
    names = (
        ...
        "score_oracle_regret", "clearance_barrier_loss",
        "clearance_pairwise_ranking_loss", "dangerous_segment_loss",
        "static_safety_loss", "smoothness_loss", "guidance_loss",
        "kinematic_loss",
    )
...
def main():
    ...
    print(json.dumps({
        ...
        "role": "high_safety_joint_retiming_shakedown",
        "run": str(run),
        "epochs_recorded": len(rows),
        "candidate_generator": "trainable_v456_candidate",
