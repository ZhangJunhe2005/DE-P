#!/usr/bin/env python3
"""Prepare the V4.5.8 localized-safety recovery shakedown."""
...
OUTPUT = ROOT / "configs/route_a_v4_5_8_localized_safety_shakedown.yaml"
PARENT_RUN_ROOT = (
...
def main():
    ...
    config["experiment_role"] = "localized_safety_retiming_shakedown"
    ...
    config["output_root"] = str(
        ROOT / "runs/route_a_static_yopo_v4_5_8_localized_safety_retimed"
    )
    config["model"].update({
    ...
    config["static_yopo_v4_5_6"]["enabled"] = False
    config["static_yopo_v4_5_8"] = {
        "enabled": True,
        "derivative_samples": 81,
        "static_safety_samples": 81,
        # Restore the original YOPO unit weights.  Unlike V4.5.7, static safety
        # is not multiplied relative to smoothness/guidance.
        ...
        # Runtime retiming, not rejection, handles an otherwise safe route.
        ...
        # No second dangerous-segment/barrier/pairwise safety objective.
    ...
    config["validation"].update({
        "contract_version": "route_a_v4_5_8_localized_safety_retimed_v1",
        "minimum_epoch": 1,
        "patience": 5,
    })
    config["implementation_hotfixes"] = [
        "route_a_v4_5_8_initialize_from_noncollapsed_v456_best_v1",
        "route_a_v4_5_8_single_localized_static_safety_cost_v1",
        "route_a_v4_5_8_restore_original_yopo_weight_ratio_v1",
        "route_a_v4_5_8_runtime_collision_infinite_training_finite_v1",
        "route_a_v4_5_8_keep_certified_candidate_retiming_v1",
        "route_a_v4_5_8_no_new_qualification_gate_v1",
    ]
    if OUTPUT.exists():
    ...
    print(json.dumps({
        ...
        "safety_curve": {
            ...
            "radius_boundary_cost": 1.0,
            "collision_surrogate_cost": 3.0,
            "runtime_collision_cost": "positive_infinity_reject",
        },
        "weights": {"smoothness": 10.0, "safety": 1.0, "guidance": 0.15},
