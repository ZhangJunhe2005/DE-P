...
CONFIG="$ROOT/configs/route_a_v4_5_5_dense_static_esdf_shakedown.yaml"
DRY_RUN=0
while [[ $# -gt 0 ]]; do
  case "$1" in
...
conda run --no-capture-output -n yopo \
  python tools/prepare_route_a_v4_5_5_training_config.py
conda run --no-capture-output -n yopo python -m pytest -q \
  tests/test_static_yopo_parity_v4_5.py \
  tests/test_static_yopo_parity_v4_5_1.py \
  tests/test_static_yopo_parity_v4_5_2.py \
  tests/test_static_yopo_parity_v4_5_5.py \
  tests/test_interactive_goal_contract_v1.py \
