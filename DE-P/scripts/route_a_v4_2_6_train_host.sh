...
CONFIG="$ROOT/configs/route_a_v4_2_6_feasibility_score_training.yaml"
RESUME_CHECKPOINT=""
DRY_RUN=0
...
conda run --no-capture-output -n yopo \
  python tools/prepare_route_a_v4_2_6_feasibility_score_training_config.py
conda run --no-capture-output -n yopo python -m pytest -q \
  tests/test_static_yopo_feasibility_score_v1.py \
  tests/test_static_yopo_progress_safety_v1.py \
