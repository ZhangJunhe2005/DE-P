...
conda run --no-capture-output -n yopo python tools/run_phase8jqv2_4perto1_review.py
...
print("PERTO1_HOST_CUDA", torch.cuda.get_device_name(0))
PY
conda run --no-capture-output -n yopo python tools/run_phase8jqv2_4perto1_host_runtime.py --device 0
